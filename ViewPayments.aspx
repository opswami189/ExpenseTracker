<%@ Page Title="ExpenseTracker - ViewPayments" Language="C#"
AutoEventWireup="true" CodeBehind="ViewPayments.aspx.cs"
MasterPageFile="~/Site1.Master" Inherits="ExpenseTracker.ViewPayments" %>
...
>
  <div style="text-align: center">
    &nbsp;Payment Details<br /> &nbsp;<asp:GridView
      ID="GridView1"
      runat="server"
    ...
    >
      <Columns>
        ...
        />
        <asp:BoundField
          DataField="Month Name"
          HeaderText="Month Name"
          ReadOnly="True"
          SortExpression="Month Name"
        />
        <asp:BoundField
          DataField="Mode"
          HeaderText="Mode"
