...
<body>
    <form id="form1" runat="server">
        ...
        <p style="color: #33CC33; text-align: center; font-style: italic; font-family: 'Times New Roman', Times, serif;">
            ...
            <br />
            <br />
            <asp:Label ID="LblFirstName" runat="server" Text="First Name: " Font-Size="Medium" ForeColor="#CC3300"></asp:Label>
            <asp:TextBox ID="TxtFirstName" runat="server" BorderStyle="Solid" Font-Size="Medium"></asp:TextBox>
            <br />
            <br />
            <asp:Label ID="LblLastName" runat="server" Text="Last Name:" Font-Size="Medium" ForeColor="#CC3300"></asp:Label>
&nbsp;<asp:TextBox ID="TxtLastName" runat="server" BorderStyle="Solid" Font-Size="Medium"></asp:TextBox>
            <br />
            <br />
            <asp:Label ID="LblEmail" runat="server" Text="Email Id:" Font-Size="Medium" ForeColor="#CC3300"></asp:Label>
&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:TextBox ID="TxtEmail" runat="server" BorderStyle="Solid" Font-Size="Medium" TextMode="Email"></asp:TextBox>
            <br />
            <br />
            <asp:Label ID="LblPassword" runat="server" Text="Password:" Font-Size="Medium" ForeColor="#CC3300"></asp:Label>
&nbsp;&nbsp;
            <asp:TextBox ID="TxtPassword" runat="server" BorderStyle="Solid" Font-Size="Medium" TextMode="Password"></asp:TextBox>
            <br />
            <br />
            <asp:Label ID="LblMobileNo" runat="server" Text="Mobile No:" Font-Size="Medium" ForeColor="#CC3300"></asp:Label>
&nbsp;
            <asp:TextBox ID="TxtMobileNo" runat="server" BorderStyle="Solid" Font-Size="Medium" TextMode="Phone"></asp:TextBox>
            <br />
            <asp:Label ID="LblEnterDetails" runat="server" Font-Size="Medium" ForeColor="Red"></asp:Label>
            <br />
            <br />
            <asp:Button ID="BtnSave" runat="server" OnClick="BtnSave_Click" Text="Save" BorderStyle="Solid" Font-Size="Medium" ForeColor="#CC3300" />
            <br />
            <br />
            <asp:Label ID="LblSignIn" runat="server" Font-Size="Small" Text="Already have an account?"></asp:Label>
            <asp:LinkButton ID="LbSignIn" runat="server" Font-Size="Small" PostBackUrl="~/SignIn.aspx">SignIn</asp:LinkButton>
            <br />
            <br />
